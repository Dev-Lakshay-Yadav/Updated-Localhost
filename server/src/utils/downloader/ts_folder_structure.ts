...
export function ensureLabFolderExists(caseId: string, creationTimeMs: number): void {
...
export function ensureCaseFolderExists(caseId: string, folderType: string): void {
